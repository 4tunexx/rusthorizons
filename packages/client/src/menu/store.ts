...
import type { StorePacketData } from '@rusthorizons/common/types/messages/outgoing';
import type { SerializedStoreItem } from '@rusthorizons/common/network/impl/store';
