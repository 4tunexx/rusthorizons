export default {
    ...
    NOT_ENOUGH_DRIVE: 'Du hast nicht genug Energie, um diese Fähigkeit einzusetzen.',
    ...
    LOW_DRIVE: 'Du hast nur noch wenig Energie, deine Angriffe werden schwächer sein.',
    ...
    TRADE_COMPLETE: 'Danke, dass du das Rust Horizons Handelssystem benutzt!',
