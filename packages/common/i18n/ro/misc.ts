export default {
    ...
    NOT_ENOUGH_DRIVE: 'You do not have enough drive to use this ability.',
    ...
    LOW_DRIVE: 'You are low on drive, your attacks will be weaker.',
    ...
    TRADE_COMPLETE: 'Thank you for using Rust Horizons trading system!',
